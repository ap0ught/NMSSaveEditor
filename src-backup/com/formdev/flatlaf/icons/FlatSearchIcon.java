...
public class FlatSearchIcon extends FlatAbstractIcon {
   ...
   protected void paintIcon(Component c, Graphics2D g) {
      g.setColor(
         this.ignoreButtonState
            ? this.searchIconColor
            : FlatButtonUI.buttonStateColor(c, this.searchIconColor, this.searchIconColor, null, this.searchIconHoverColor, this.searchIconPressedColor)
      );
      if (this.area == null) {
