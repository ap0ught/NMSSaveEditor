...
public class FlatWindowRestoreIcon extends FlatWindowAbstractIcon {
   ...
   protected void paintIconAt1x(Graphics2D g, int x, int y, int width, int height, double scaleFactor) {
      ...
      Path2D r1 = SystemInfo.isWindows_11_orLater
         ? FlatUIUtils.createRoundRectangle(
            (float)(ix + ro2), (float)iy, (float)rwh, (float)rwh, thickness, (float)arc, (float)arcOuter, (float)arc, (float)arc
         )
         : FlatUIUtils.createRectangle((float)(ix + ro2), (float)iy, (float)rwh, (float)rwh, thickness);
      Path2D r2 = SystemInfo.isWindows_11_orLater
         ? FlatUIUtils.createRoundRectangle((float)ix, (float)(iy + ro2), (float)rwh, (float)rwh, thickness, (float)arc, (float)arc, (float)arc, (float)arc)
         : FlatUIUtils.createRectangle((float)ix, (float)(iy + ro2), (float)rwh, (float)rwh, thickness);
