...
public class FlatPasswordFieldUI extends FlatTextFieldUI {
   ...
   public Object getStyleableValue(JComponent c, String key) {
      return key.equals("capsLockIconColor") && this.capsLockIcon instanceof FlatCapsLockIcon
         ? ((FlatCapsLockIcon)this.capsLockIcon).getStyleableValue(key)
         : super.getStyleableValue(c, key);
   }
   ...
   protected boolean isCapsLockVisible() {
      return !this.showCapsLock ? false : FlatUIUtils.isPermanentFocusOwner(this.getComponent()) && Toolkit.getDefaultToolkit().getLockingKeyState(20);
   }
