   ...
   protected MouseWheelListener createMouseWheelListener() {
      ...
      return e -> {
         if (this.isSmoothScrollingEnabled()
            && this.scrollpane.isWheelScrollingEnabled()
            && e.getScrollType() == 0
            && e.getPreciseWheelRotation() != 0.0
            && e.getPreciseWheelRotation() != (double)e.getWheelRotation()) {
         ...
         switch (var3) {
            ...
            case "UPPER_RIGHT_CORNER":
               ...
               if (corner instanceof JButton
                  ...
                  && this.scrollpane.getViewport() != null
