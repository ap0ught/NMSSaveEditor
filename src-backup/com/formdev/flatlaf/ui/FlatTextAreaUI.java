...
public class FlatTextAreaUI extends BasicTextAreaUI implements FlatStylingSupport.StyleableUI {
   ...
   private void updateBackground() {
      FlatTextFieldUI.updateBackground(
   ...
   private Dimension applyMinimumWidth(JComponent c, Dimension size) {
      return c instanceof JTextArea && ((JTextArea)c).getColumns() > 0
         ? size
         : FlatEditorPaneUI.applyMinimumWidth(c, size, this.minimumWidth, this.defaultMargin);
   }
