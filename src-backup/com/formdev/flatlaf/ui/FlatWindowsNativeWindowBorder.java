...
class FlatWindowsNativeWindowBorder implements FlatNativeWindowBorder.Provider {
   ...
   private void uninstall(Window window) {
      FlatWindowsNativeWindowBorder.WndProc wndProc = this.windowsMap.remove(window);
      if (wndProc != null) {
         wndProc.uninstall();
      }
   }
   ...
   public void updateTitleBarInfo(
      ...
      FlatWindowsNativeWindowBorder.WndProc wndProc = this.windowsMap.get(window);
      if (wndProc != null) {
   ...
   private class WndProc implements PropertyChangeListener {
      ...
      private boolean isFullscreen() {
         GraphicsConfiguration gc = this.window.getGraphicsConfiguration();
         return gc == null ? false : gc.getDevice().getFullScreenWindow() == this.window;
      }
