...
public class Application {
   ...
   private fe aV = (var1x, var2x, var3x) -> {
      this.aO = true;
      this.aP = true;
      if (var3x == null) {
   ...
   private fe aW = (var1x, var2x, var3x) -> {
      this.aL = true;
      if (var1x.startsWith("PlayerStateData.Multitools")) {
         ...
         if (var1x.startsWith("PlayerStateData.Multitools[" + var4 + "].Store.")) {
            eY var5x = this.aK.H("PlayerStateData.Multitools[" + var4 + "].Store");
            this.aK.b("PlayerStateData.WeaponInventory", var5x.bE());
   ...
   private void f() {
      ...
      if (this.aS) {
         this.aS = false;
         int var1 = this.aH < 0 ? -1 : this.aG[this.aH].getIndex();
         this.aG = Arrays.asList(this.aF.bU()).stream().filter(var1x -> var1x.getIndex() == var1 || !var1x.isEmpty()).toArray(ft[]::new);
         this.aH = -1;
      ...
      this.aT = this.aT & this.aH >= 0;
      if (this.aT) {
         this.aT = false;
         String var7 = this.aJ < 0 ? null : this.aI[this.aJ].K();
         long var9 = this.aJ < 0 ? Long.MIN_VALUE : this.aI[this.aJ].lastModified();
         fn var4 = this.aJ < 0 ? null : this.aI[this.aJ].L();
         this.aI = this.aG[this.aH].bX();
         this.aJ = -1;

         for (int var5 = 0; var5 < this.aI.length; var5++) {
         ...
         if (var7 != null && this.aJ < 0) {
            this.aU = false;
            int var10 = JOptionPane.showConfirmDialog(
               this.N, "Save file has been deleted externally. Would you like to reload?\nNOTE: All changes made in the editor will be lost.", "Reload File", 0
            );
            if (var10 == 0) {
               this.aJ = 0;
               this.l();
               ...
               var6[0] = new F(this, var7, var9, var4, this.aK);
      ...
      this.aU = this.aU & this.aJ >= 0;
      if (this.aU) {
         this.aU = false;
         int var8 = JOptionPane.showConfirmDialog(
            this.N, "Save file has been modified externally. Would you like to reload?\nNOTE: All changes made in the editor will be lost.", "Reload File", 0
         );
         if (var8 == 0) {
            this.l();
         } else {
            ...
            try {
               ...
               if (!var4.aw()) {
                  ...
                  for (int var19 = 0; var19 < var12.size(); var19++) {
                     eY var20 = var12.V(var19);
                     if (!var20.getValueAsString("Type.InventoryType").equals("Technology")) {
                        var12.ac(var19--);
                     }
                  }
               }
            ...
            try {
               ...
               for (Entry var9 : var6.entrySet()) {
                  ...
                  if (((String)var9.getKey()).equals("Inventory")) {
                     var7.b("FreighterInventory", (eY)var9.getValue());
                     var8 = true;
                  }

                  if (((String)var9.getKey()).equals("InventoryTech")) {
                     var7.b("FreighterInventory_TechOnly", (eY)var9.getValue());
                     var8 = true;
                  }

                  if (((String)var9.getKey()).equals("InventoryCargo")) {
                     var7.b("FreighterInventory_Cargo", (eY)var9.getValue());
                     var8 = true;
                  }
               }
            ...
            if (var2 != null) {
               ...
               for (int var5 = 0; var5 < this.aG.length; var5++) {
                  if (this.aF.W(var2) == this.aG[var5].getIndex()) {
                     ...
                     for (int var6 = 0; var6 < this.aI.length; var6++) {
   ...
   public List g(int var1) {
      ...
      gz var4 = this.as.X();
      if (var4 != null) {
         var2.addAll(var4.cC().stream().filter(var1x -> var1x.ay(var1)).collect(Collectors.toList()));
      }
      ...
      for (int var7 = 0; var7 < var10.length; var7++) {
         var2.addAll(var10[var7].cC().stream().filter(var1x -> var1x.ay(var1)).collect(Collectors.toList()));
      }

      gm var11 = this.aw.Z();
      if (var11 != null) {
         var2.addAll(var11.cC().stream().filter(var1x -> var1x.ay(var1)).collect(Collectors.toList()));
      }

      gO[] var8 = this.ay.aT();

      for (int var9 = 0; var9 < var8.length; var9++) {
         var2.addAll(var8[var9].cC().stream().filter(var1x -> var1x.ay(var1)).collect(Collectors.toList()));
      }

      ge var12 = this.aA.O();
      if (var12 != null) {
         var2.addAll(var12.cC().stream().filter(var1x -> var1x.ay(var1)).collect(Collectors.toList()));
      }
   ...
   private void p() {
      ...
      hl var2 = hl.n(var1);
      if ((var2 = nomanssave.aj.a(this.N, var2)) != null) {
         var2.aL(0);
         this.aK.b("PlayerStateData.UniverseAddress", var2.ew());
   ...
   private static void a(Window var0) {
      ...
      Window[] var4;
      for (Window var1 : var4 = var0.getOwnedWindows()) {
         a(var1);
      }
   }
   ...
   public fn F() {
      ...
      fn var6 = this.aI[this.aJ].L();
      if (var6 == fn.lr) {
         String var7 = this.aK.getValueAsString("PlayerStateData.SeasonData.GameMode.PresetGameMode");
         if ("Normal".equals(var7)) {
            var6 = fn.lm;
         }

         if ("Creative".equals(var7)) {
            var6 = fn.lo;
         }

         if ("Survival".equals(var7)) {
            var6 = fn.ln;
         }

         if ("Ambient".equals(var7)) {
            var6 = fn.lp;
         }

         if ("Permadeath".equals(var7)) {
            var6 = fn.lq;
         }
      }
   ...
   public gp[] k(int var1) {
      ...
      if (var2 != null && var1 < var2.size()) {
         ...
         for (int var9 = 0; var9 < var3.size(); var9++) {
            eY var19 = var3.V(var9);
            eV var7 = var19.d("ActiveFrigateIndices");

            for (int var10 = 0; var10 < var7.size(); var10++) {
               int var12;
               if ((var12 = var7.Y(var10)) > var1) {
                  var7.a(var10, var12 - 1);
               }
            }

            var7 = var19.d("DamagedFrigateIndices");

            for (int var25 = 0; var25 < var7.size(); var25++) {
               int var13;
               if ((var13 = var7.Y(var25)) > var1) {
                  var7.a(var25, var13 - 1);
               }
            }

            var7 = var19.d("DestroyedFrigateIndices");

            for (int var26 = 0; var26 < var7.size(); var26++) {
               int var14;
               if ((var14 = var7.Y(var26)) > var1) {
                  var7.a(var26, var14 - 1);
               }
            }

            var7 = var19.d("AllFrigateIndices");

            for (int var27 = 0; var27 < var7.size(); var27++) {
               int var15;
               if ((var15 = var7.Y(var27)) > var1) {
                  var7.a(var27, var15 - 1);
               }
            }

            eV var8 = var19.d("Events");

            for (int var28 = 0; var28 < var7.size(); var28++) {
               eY var6 = var8.V(var28);
               var7 = var6.d("AffectedFrigateIndices");

               for (int var11 = 0; var11 < var7.size(); var11++) {
                  int var16;
                  if ((var16 = var7.Y(var11)) > var1) {
                     var7.a(var11, var16 - 1);
                  }
               }
               ...
               for (int var29 = 0; var29 < var7.size(); var29++) {
                  int var17;
                  if ((var17 = var7.Y(var29)) > var1) {
                     var7.a(var29, var17 - 1);
                  }
               }
               ...
               for (int var30 = 0; var30 < var7.size(); var30++) {
                  int var18;
                  if ((var18 = var7.Y(var30)) > var1) {
                     var7.a(var30, var18 - 1);
                  }
               }
            }
         }
   ...
   private void G() {
      ...
      eV var12 = this.aK.d("PlayerStateData.MaintenanceInteractions");

      for (int var13 = 0; var13 < var12.size(); var13++) {
         eY var14 = var12.V(var13);
         eV var8 = var14.d("InventoryContainer.Slots");

         for (int var9 = 0; var9 < var8.size(); var9++) {
            eY var10 = var8.V(var9);
            if ("^MAINT_FARM5".equals(var10.getValueAsString("Id"))) {
               int var11;
               if ((var11 = var10.J("MaxAmount")) > 0 && var10.J("Amount") < var11) {
                  var10.b("Amount", new Integer(var11));
               }

               var14.b("LastUpdateTimestamp", new Integer(var1));
               this.aL = true;
               var2--;
            }
         }
   ...
   private void initialize() {
      ...
      ba var3 = new ba(nomanssave.aH.cH, nomanssave.aH.cI, 0);
      this.O.addTab("Main", null, var3, null);
      var3.k("File Details");
      this.P = new JLabel();
      ...
      this.W.setEnabled(false);
      this.W.addActionListener(var1x -> this.l());
      var4.add(this.W);
      this.X = new JButton("Save Changes");
      this.X.setEnabled(false);
      this.X.addActionListener(var1x -> this.n());
      var4.add(this.X);
      this.Y = new JButton("Save As");
      this.Y.setEnabled(false);
      this.Y.addActionListener(var1x -> this.o());
      var4.add(this.Y);
      var3.a(null, var4, 2);
      this.as = new aJ(this);
      ...
      this.O.addChangeListener(var1x -> {
         ...
         if (this.aF != null && this.aO && this.aP) {
            int var2x = JOptionPane.showConfirmDialog(this.N, "Save account data?", "Save", 0);
            this.aP = var2x == 0;
            if (this.aP) {
               this.m();
            }
      ...
      var8.addActionListener(var1x -> {
         if (this.aL || this.aO) {
            int var2x = JOptionPane.showConfirmDialog(this.N, "Save data before closing?", "Save", 0);
            if (var2x == 0) {
               if (this.aL) {
                  this.n();
               }
      ...
      var10.addActionListener(var1x -> this.q());
      var9.add(var10);
      this.ac.add(var10);
      JMenuItem var11 = new JMenuItem("Export JSON");
      var11.addActionListener(var1x -> this.u());
      var9.add(var11);
      this.ac.add(var11);
      JMenuItem var12 = new JMenuItem("Import JSON");
      var12.addActionListener(var1x -> this.v());
      var9.add(var12);
      this.ac.add(var12);
      JMenuItem var13 = new JMenuItem("Coordinate Viewer");
      var13.addActionListener(var1x -> this.p());
      var9.add(var13);
      this.ac.add(var13);
      JCheckBoxMenuItem var14 = new JCheckBoxMenuItem("Test Mode");
      var14.setSelected(en.aS());
      var14.addActionListener(
         var2x -> {
            boolean var3x = var14.isSelected();
            if (var3x) {
               int var4x = JOptionPane.showConfirmDialog(
                  this.N,
                  "This mode removes any restrictions imposed by the editor.\nUSE WITH CAUTION: Changes made in test mode may not work in game.",
                  "Test Mode",
                  2
               );
               if (var4x == 2) {
