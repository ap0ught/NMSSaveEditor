...
public class ap extends JPanel {
   ...
   ap(Application var1) {
      ...
      for (int var16 = 2; var16 < this.cn.getColumnCount(); var16++) {
      ...
      for (int var30 = 2; var30 < this.cn.getModel().getColumnCount(); var30++) {
         this.co.setSortable(var30, false);
      }
      ...
      var31.addActionListener(new ay(this));
      var6.add(var31);
   ...
   public void a(gz var1) {
      ...
      if (this.cr != null) {
         for (int var2 = 0; var2 < this.cr.size(); var2++) {
            String var3 = this.cr.X(var2);
      ...
      if (this.cs != null) {
         for (int var5 = 0; var5 < this.cs.size(); var5++) {
            String var7 = this.cs.X(var5);
            if (!this.ct.contains(var7)) {
               this.ct.add(var7);
            }
         }
      }
      ...
      this.ck.updateUI();
      int var6 = var1 == null ? 0 : var1.dP();

      for (int var8 = 0; var8 < 16; var8++) {
         int var4 = 1 << var8;
         this.cm[var8].setSelected((var6 & var4) == var4);
      }
