...
public class cg extends JDialog {
   ...
   private void a(gQ var1) {
      ...
      if (this.fA != null && this.fA.bb()) {
         ...
         try {
            int var10 = hf.b(var4, 0, 99999);
            this.fC = new Integer(var10);
      ...
      String var8 = this.fA == null ? "" : this.fA.bk().stream().map(var0 -> {
         ey var1x = ey.d(var0.getID());
         return var1x != null ? var1x.getName() + " (x" + var0.bo() + ")" : var0.getID() + " (x" + var0.bo() + ")";
      }).collect(Collectors.joining("\n"));
      if (var8.length() == 0) {
         var8 = "N/A";
      }

      this.fy.setText(var8);
