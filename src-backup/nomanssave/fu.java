...
public class fu implements fq {
   ...
   fu(File var1, fR var2) {
      ...
      try {
         ...
         for (int var22 = 0; var22 < this.lF.length; var22++) {
            this.lF[var22] = new fw(this, var3);
            if (this.lF[var22].isValid()) {
         ...
         for (int var23 = 0; var23 < this.lF.length; var23++) {
            if (this.lF[var23].isValid()) {
               var3.skip(this.lF[var23].lP - var4);
               var4 = this.lF[var23].lP;
               ...
               if (var12.matches()) {
                  try {
                     this.lF[var23].be = ag(Integer.parseInt(var12.group(1)));
      ...
      for (int var21 = 0; var21 < this.lF.length; var21++) {
         if (this.lF[var21].isValid()) {
            if (this.lF[var21].lN == 262144 && this.lG == null) {
               this.lG = new fv(this, this.lF[var21]);
            }

            if (this.lF[var21].lN == 3145728 && this.lF[var21].lO >= 2) {
               this.lH[this.lF[var21].lO - 2] = new fx(this, this.lF[var21]);
            }
         }
      }
   ...
   public static void main(String[] var0) {
      new fu(new File("D:\\Temp\\PS4_NEW"), null);
   }
