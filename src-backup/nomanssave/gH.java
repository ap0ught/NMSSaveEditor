...
public class gH {
         ...
         if (var3 < 0) {
            ...
            if (var16 == null) {
               ...
               if (var6 != null && ((eV)var6).ab(0)) {
                  var2.a(var3, var14);
                  return new gH(var3, var14, var16, var14.H("Inventory_TechOnly"), var14.H("Inventory_Cargo"));
               } else {
                  throw new RuntimeException("Invalid ship data");
               }
            }
   ...
   public void ag(String var1) {
      this.rp.b("Resource.Filename", var1);
      gL var2 = gL.aw(var1);
      this.gT.stream().forEach(var1x -> var1x.az(var2 == null ? 4 : var2.ea()));
      if (var2 == gL.rx) {
   ...
   public void aj(String var1) {
      this.rp.b("Inventory.Class.InventoryClass", var1);
   ...
   private void av(String var1) {
      this.gT.stream().forEach(var1x -> var1x.ap(var1));
   }
