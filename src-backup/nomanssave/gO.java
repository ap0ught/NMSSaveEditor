...
public class gO {
   ...
   public static gO[] E(eY var0) {
      ...
      if (var1 != null && var1.size() != 0) {
         ...
         eY var6 = var0.H("FishPlatformInventory");
         if (var5 != null && var6 != null) {
            var2.add(new gO(var5, var6));
         }

         return var2.toArray(new gO[0]);
      } else {
         return new gO[0];
      }
   }
   ...
   private static Function a(gO var0, String var1) {
      return var2 -> new String[]{var0.getType(), var1};
   }
