...
public class gp {
   ...
   public void c(gr var1) {
      this.oR.b("FrigateClass.FrigateClass", var1.toString());
   }
   ...
   public void as(int var1) {
      this.oR.b("TotalNumberOfExpeditions", new Integer(var1));
   }
   ...
   public void at(int var1) {
      this.oR.b("TotalNumberOfSuccessfulEvents", new Integer(var1));
   }
   ...
   public void au(int var1) {
      this.oR.b("TotalNumberOfFailedEvents", new Integer(var1));
   }
   ...
   public void av(int var1) {
      this.oR.b("NumberOfTimesDamaged", new Integer(var1));
   }
   ...
   public void aw(int var1) {
      this.oR.b("RepairsMade", new Integer(var1));
   }
   ...
   public void ax(int var1) {
      this.oR.b("DamageTaken", new Integer(var1));
   }
