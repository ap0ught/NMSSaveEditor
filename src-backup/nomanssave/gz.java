...
public class gz {
   ...
   private static Function au(String var0) {
      return var1 -> new String[]{"Exosuit", var0};
   }
   ...
   private gz(eY var1, eV var2, eY var3, eY var4, eY var5) {
      ...
      if (var6.size() > 0) {
         ...
         while (var8 < var6.size()) {
            ...
            if (var10 == null) {
               ...
               for (String var11 : var10.bw()) {
                  eU var13 = var10.z(var11);
                  if (var13 != null) {
                     eY var14 = new eY();
                     var14.b("Group", var11);
                     eV var15 = new eV(Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE);
      ...
      var17.add(new gt(au(var18), var3, var20, var25, var26, false, true));
      if (var4 != null) {
         var17.add(new gt(au("Technology"), var4, var22, var27, var16, true, true));
      }
   ...
   public void e(long var1) {
      this.oI.b("Units", new Integer((int)var1));
   }
   ...
   public void f(long var1) {
      this.oI.b("Nanites", new Integer((int)var1));
   }
   ...
   public void g(long var1) {
      this.oI.b("Specials", new Integer((int)var1));
   }
   ...
   public void aB(int var1) {
      this.oI.b("Health", new Integer(var1));
   }
   ...
   public void aC(int var1) {
      this.oI.b("Shield", new Integer(var1));
   }
   ...
   public void aD(int var1) {
      this.oI.b("Energy", new Integer(var1));
   }
   ...
   public void aE(int var1) {
      this.oI.b("KnownPortalRunes", new Integer(var1));
   }
   ...
   private void a(String var1, int var2, boolean var3) {
      ...
      if (var3) {
         ...
         while (var9.size() < eU.values().length) {
            var9.add(Boolean.FALSE);
         }

         var9.a(var2, new Boolean(var3));
         var8.b("Races", var9);
         this.rc.f(var8);
      }
   }
   ...
   public void g(double var1) {
      ...
      if (var3 >= 0L && var3 <= 2147483647L) {
         this.oI.b("HazardTimeAlive", new Integer((int)var3));
      } else {
   ...
   public void a(gs var1, int var2) {
      if (var2 < 0) {
         ...
         for (int var4 = 0; var4 < this.rb.size(); var4++) {
            eY var3 = this.rb.V(var4);
            if (var3.getValueAsString("Id").equals(var1.id)) {
               var3.b("Value.IntValue", new Integer(var2));
               return;
            }
         }
         ...
         var5.b("Id", var1.id);
         eY var6 = new eY();
         var6.b("IntValue", new Integer(var2));
         var6.b("FloatValue", new Double(0.0));
         var6.b("Denominator", new Double(0.0));
         var5.b("Value", (Object)var6);
         this.rb.f(var5);
      }
   }
   ...
   public void a(gs var1, double var2) {
      if (var2 < 0.0) {
         ...
         for (int var5 = 0; var5 < this.rb.size(); var5++) {
            eY var4 = this.rb.V(var5);
            if (var4.getValueAsString("Id").equals(var1.id)) {
               var4.b("Value.FloatValue", new Double(var2));
               return;
            }
         }
         ...
         var6.b("Id", var1.id);
         eY var7 = new eY();
         var7.b("IntValue", new Integer(0));
         var7.b("FloatValue", new Double(var2));
         var7.b("Denominator", new Double(0.0));
         var6.b("Value", (Object)var7);
         this.rb.f(var6);
      }
   }
}
