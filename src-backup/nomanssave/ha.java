...
public class ha extends FilterInputStream {
            ...
            if (this.sg == this.buffer.length && !this.sj) {
               ...
               if (var11 < 0) {
                  ...
                  if (var5 < 0) {
                     ...
                     } else if (var11 > this.sg) {
                        throw new EOFException("Buffer too small");
                     } else {
                        this.aJ(var3);
                        if (var3 > var11) {
                           int var6 = this.sg - var11;

                           do {
                              System.arraycopy(this.buffer, var6, this.buffer, this.sg, var11);
                              var3 -= var11;
                              this.sg += var11;
                           } while (var3 > var11);
                           ...
                           System.arraycopy(this.buffer, this.sg - var11, this.buffer, this.sg, var3);
                           this.sg += var3;
                        }

                        this.sl = Math.max(this.sl, var11);
                        return true;
                     }
                  }
               }
   ...
   @Override
   public int read() {
      return this.sk == this.sg && !this.el() ? -1 : 0xFF & this.buffer[this.sk++];
   }
