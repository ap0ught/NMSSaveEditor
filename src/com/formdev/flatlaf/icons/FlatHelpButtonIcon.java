...
public class FlatHelpButtonIcon extends FlatAbstractIcon {
   ...
   protected void paintIcon(Component c, Graphics2D g2) {
      ...
      g2.setColor(
         FlatUIUtils.deriveColor(
            FlatButtonUI.buttonStateColor(c, this.background, this.disabledBackground, this.focusedBackground, this.hoverBackground, this.pressedBackground),
            this.background
         )
      );
      g2.fill(new Float(xy, xy, wh, wh));
