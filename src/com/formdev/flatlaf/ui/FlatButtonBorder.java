...
public class FlatButtonBorder extends FlatBorder {
   ...
   protected int field_52 = UIManager.getInt("Button.arc");
   ...
   protected Color getFocusColor(Component c) {
      return this.toolbarFocusColor != null && FlatButtonUI.isToolBarButton(c)
         ? this.toolbarFocusColor
         : (FlatButtonUI.isDefaultButton(c) ? this.defaultFocusColor : super.getFocusColor(c));
   }
   ...
   protected Paint getBorderColor(Component c) {
      ...
      Paint color = FlatButtonUI.buttonStateColor(
         c,
         def ? this.defaultBorderColor : this.borderColor,
         this.disabledBorderColor,
         def ? this.defaultFocusedBorderColor : this.focusedBorderColor,
         def ? this.defaultHoverBorderColor : this.hoverBorderColor,
         null
      );
   ...
   public Insets getBorderInsets(Component c, Insets insets) {
      if (FlatButtonUI.isToolBarButton(c)) {
         ...
         FlatUIUtils.setInsets(
            insets,
            UIScale.scale(FlatUIUtils.addInsets(this.toolbarSpacingInsets, margin != null && !(margin instanceof UIResource) ? margin : this.toolbarMargin))
         );
      } else {
