...
public class FlatCaret extends DefaultCaret implements UIResource {
   ...
   public void deinstall(JTextComponent c) {
      c.putClientProperty(
         "FlatLaf.internal.caretInfo", new long[]{(long)this.getDot(), (long)this.getMark(), (long)this.getBlinkRate(), System.currentTimeMillis()}
      );
      super.deinstall(c);
   }
   ...
   protected void adjustVisibility(Rectangle nloc) {
      ...
      if (c != null && c.getUI() instanceof FlatTextFieldUI) {
         ...
         if (r != null) {
            nloc.x = nloc.x - (r.x - c.getInsets().left);
         }
      }
