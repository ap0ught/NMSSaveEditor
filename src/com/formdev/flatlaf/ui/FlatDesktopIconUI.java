...
public class FlatDesktopIconUI extends BasicDesktopIconUI {
      ...
      if (MultiResolutionImageSupport.isAvailable()) {
         ...
         if (scaleFactor != 1.0 && scaleFactor != 2.0) {
            Image previewImageCurrent = frameImage.getScaledInstance(
               (int)Math.round((double)previewWidth * scaleFactor), (int)Math.round((double)previewHeight * scaleFactor), 4
            );
            previewImage = scaleFactor < 2.0
   ...
   private class FlatDesktopIconLayout implements LayoutManager {
      ...
      public void layoutContainer(Container parent) {
         ...
         FlatDesktopIconUI.this.dockIcon
            .setBounds(insets.left, insets.top, parent.getWidth() - insets.left - insets.right, parent.getHeight() - insets.top - insets.bottom);
