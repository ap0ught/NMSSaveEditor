...
public class FlatMenuItemRenderer {
   ...
   protected Dimension getPreferredMenuItemSize() {
      ...
      SwingUtilities.layoutCompoundLabel(
         this.menuItem,
         this.menuItem.getFontMetrics(isTopLevelMenu ? this.getTopLevelFont() : this.menuItem.getFont()),
         this.menuItem.getText(),
         this.getIconForLayout(),
         this.menuItem.getVerticalAlignment(),
         this.menuItem.getHorizontalAlignment(),
         this.menuItem.getVerticalTextPosition(),
         this.menuItem.getHorizontalTextPosition(),
         viewRect,
         iconRect,
         textRect,
   ...
   protected void paintMenuItem(
      ...
      Insets insets = this.menuItem.getInsets();
      viewRect.x = viewRect.x + insets.left;
      viewRect.y = viewRect.y + insets.top;
      viewRect.width = viewRect.width - (insets.left + insets.right);
      viewRect.height = viewRect.height - (insets.top + insets.bottom);
      Rectangle iconRect = new Rectangle();
      Rectangle textRect = new Rectangle();
      ...
      this.paintIcon(
         g, iconRect, this.getIconForPainting(), underlineSelection ? this.underlineSelectionCheckBackground : this.checkBackground, selectionBackground
      );
   ...
   protected void paintSelection(Graphics g, Color selectionBackground, Insets selectionInsets, int selectionArc) {
      ...
      FlatUIUtils.paintSelection(
         (Graphics2D)g, 0, 0, this.menuItem.getWidth(), this.menuItem.getHeight(), UIScale.scale(selectionInsets), arc, arc, arc, arc, 0
      );
   }
   ...
   protected void paintText(Graphics g, Rectangle textRect, String text, Color selectionForeground, Color disabledForeground) {
      ...
      if (htmlView != null) {
         ...
         paintText(
            ...
            text,
            mnemonicIndex,
            isTopLevelMenu ? this.getTopLevelFont() : this.menuItem.getFont(),
            foreground,
            this.isUnderlineSelection() ? foreground : selectionForeground,
            disabledForeground
         );
      }
   }
   ...
   protected static void paintText(
      Graphics g,
      JMenuItem menuItem,
      Rectangle textRect,
      String text,
   ...
   private Icon getIconForPainting() {
      ...
      if (icon == null && this.checkIcon != null && !isTopLevelMenu(this.menuItem)) {
         ...
         if (isArmedOrSelected(this.menuItem)) {
            Icon selectedIcon = this.menuItem.getSelectedIcon();
