...
public class FlatTitlePane extends JComponent {
      ...
      this.setLayout(
         new BorderLayout() {
            ...
            public void layoutContainer(Container target) {
               ...
               if (titleWidth < minTitleWidth) {
                  int minLeftWidth = FlatTitlePane.this.iconLabel.isVisible()
                     ? FlatTitlePane.this.iconLabel.getWidth() - FlatTitlePane.this.iconLabel.getInsets().right
                     : UIScale.scale(FlatTitlePane.this.noIconLeftGap);
               ...
               if (FlatTitlePane.this.hasVisibleEmbeddedMenuBar(menuBar)) {
                  ...
                  if (horizontalGlue != null) {
                     ...
                     FlatTitlePane.this.titleLabel
                        .setBounds(
                           FlatTitlePane.this.titleLabel.getX() + glueLocation.x,
                           FlatTitlePane.this.titleLabel.getY(),
                           horizontalGlue.getWidth(),
                           FlatTitlePane.this.titleLabel.getHeight()
                        );
                  }
               }
            }
   ...
   protected void createButtons() {
      ...
      this.buttonPanel = new JPanel() {
         ...
         public Dimension getPreferredSize() {
            ...
            if (FlatTitlePane.this.buttonMaximizedHeight > 0
               && FlatTitlePane.this.isWindowMaximized()
               && !FlatTitlePane.this.hasVisibleEmbeddedMenuBar(FlatTitlePane.this.rootPane.getJMenuBar())) {
   ...
   protected void activeChanged(boolean active) {
      ...
      Color foreground = FlatClientProperties.clientPropertyColor(this.rootPane, "JRootPane.titleBarForeground", null);
      ...
      if (foreground == null) {
         ...
         titleForeground = active && this.hasVisibleEmbeddedMenuBar(this.rootPane.getJMenuBar())
            ? FlatUIUtils.nonUIResource(this.embeddedForeground)
            : foreground;
      }
      ...
      if (this.window != null && this.rootPane.getWindowDecorationStyle() == 1) {
         ...
         if (this.window instanceof Frame) {
            ...
            if (this.isWindowMaximized()
               && (!SystemInfo.isLinux || !FlatNativeLinuxLibrary.isWMUtilsSupported(this.window))
               && this.rootPane.getClientProperty("_flatlaf.maximizedBoundsUpToDate") == null) {
   ...
   protected Rectangle getMenuBarBounds() {
      ...
      Rectangle bounds = new Rectangle(
         SwingUtilities.convertPoint(this.menuBarPlaceholder, -insets.left, -insets.top, this.rootPane), this.menuBarPlaceholder.getSize()
      );
      Insets borderInsets = this.getBorder().getBorderInsets(this);
      bounds.height = bounds.height + borderInsets.bottom;
      Component horizontalGlue = this.findHorizontalGlue(this.rootPane.getJMenuBar());
      if (horizontalGlue != null) {
         boolean leftToRight = this.getComponentOrientation().isLeftToRight();
         int titleWidth = leftToRight
            ? this.buttonPanel.getX() - (this.leftPanel.getX() + this.leftPanel.getWidth())
            : this.leftPanel.getX() - (this.buttonPanel.getX() + this.buttonPanel.getWidth());
   ...
   protected void paintComponent(Graphics g) {
      g.setColor(
         UIManager.getBoolean("TitlePane.unifiedBackground")
               && FlatClientProperties.clientPropertyColor(this.rootPane, "JRootPane.titleBarBackground", null) == null
   ...
   protected void updateMaximizedBounds() {
      ...
      if (!this.hasNativeCustomDecoration()
         && (oldMaximizedBounds == null || Objects.equals(oldMaximizedBounds, this.rootPane.getClientProperty("_flatlaf.maximizedBounds")))) {
   ...
   private boolean isMaximizedBoundsFixed() {
      return SystemInfo.isJava_15_orLater
         || SystemInfo.javaVersion >= SystemInfo.toVersion(11, 0, 8, 0) && SystemInfo.javaVersion < SystemInfo.toVersion(12, 0, 0, 0)
         || SystemInfo.javaVersion >= SystemInfo.toVersion(13, 0, 4, 0) && SystemInfo.javaVersion < SystemInfo.toVersion(14, 0, 0, 0);
   }
         ...
         if (this.hasNativeCustomDecoration()) {
            ...
            if (!this.showIconBesideTitle && this.iconLabel.isVisible()) {
               ...
               Rectangle iconBounds = new Rectangle(
                  ...
                  this.iconLabel.getWidth() - iconInsets.left - iconInsets.right + 2,
                  this.iconLabel.getHeight() - iconInsets.top - iconInsets.bottom + 2
               );
               if (this.isWindowMaximized()) {
                  iconBounds.height = iconBounds.height + iconBounds.y;
                  iconBounds.y = 0;
                  if (this.window.getComponentOrientation().isLeftToRight()) {
                     iconBounds.width = iconBounds.width + iconBounds.x;
                     iconBounds.x = 0;
                  } else {
                     iconBounds.width = iconBounds.width + iconInsets.right;
                  }
               }
               ...
               Rectangle viewR = new Rectangle(
                  insets.left, insets.top, this.titleLabel.getWidth() - insets.left - insets.right, this.titleLabel.getHeight() - insets.top - insets.bottom
               );
               ...
               ui.layoutCL(
                  ...
                  this.titleLabel.getText(),
                  this.titleLabel.getIcon(),
                  viewR,
                  iconR,
                  textR
               );
               if (iconR.x == 0) {
                  Point locationx = SwingUtilities.convertPoint(this.titleLabel, 0, 0, this.window);
                  iconR.x = iconR.x + locationx.x;
                  iconR.y = iconR.y + locationx.y;
                  iconR.x--;
                  iconR.y--;
                  iconR.width += 2;
                  iconR.height += 2;
               ...
               if (r != null) {
                  ...
                  for (int i = count - 1; i >= 0; i--) {
                     ...
                     if (c instanceof Filler
                        || c instanceof JComponent && FlatClientProperties.clientPropertyBoolean((JComponent)c, "JComponent.titleBarCaption", false)) {
            ...
            FlatNativeWindowBorder.setTitleBarHeightAndHitTestSpots(
               this.window, titleBarHeight, hitTestSpots, appIconBounds, minimizeButtonBounds, maximizeButtonBounds, closeButtonBounds
            );
   ...
   protected class FlatTitlePaneBorder extends AbstractBorder {
      ...
      public Insets getBorderInsets(Component c, Insets insets) {
         ...
         if (menuBarBorder != null) {
            ...
            insets.bottom = insets.bottom + menuBarInsets.bottom;
         } else if (FlatTitlePane.this.borderColor != null
            && (FlatTitlePane.this.rootPane.getJMenuBar() == null || !FlatTitlePane.this.rootPane.getJMenuBar().isVisible())) {
            insets.bottom = insets.bottom + UIScale.scale(1);
         }
