...
public class JBRCustomDecorations {
   ...
   static class JBRWindowTopBorder extends EmptyBorderUIResource {
      ...
      void installListeners() {
         ...
         PropertyChangeListener l = e -> this.activeColor = this.calculateActiveBorderColor();
      ...
      public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
         ...
         g.setColor(
            active
               ? (this.activeColor != null ? this.activeColor : (dark ? this.activeDarkColor : this.activeLightColor))
               : (dark ? this.inactiveDarkColor : this.inactiveLightColor)
         );
