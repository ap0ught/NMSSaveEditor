...
public class Animator {
   ...
   private final ArrayList<Animator.TimingTarget> targets = new ArrayList<>();
   ...
   private void timingEvent(float fraction) {
      synchronized (this.targets) {
         for (Animator.TimingTarget target : this.targets) {
