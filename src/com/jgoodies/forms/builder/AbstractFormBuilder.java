...
public abstract class AbstractFormBuilder {
   ...
   public final void nextColumn(int columns) {
      this.currentCellConstraints.gridX = this.currentCellConstraints.gridX + columns * this.getColumnIncrementSign();
   }
   ...
   // $VF: renamed from: add (java.awt.Component, java.lang.String) java.awt.Component
   public final Component method_88(Component component, String encodedCellConstraints) {
      this.container.add(component, new CellConstraints(encodedCellConstraints));
      return component;
   }

   // $VF: renamed from: add (java.awt.Component) java.awt.Component
   public final Component method_89(Component component) {
      this.method_87(component, this.currentCellConstraints);
      return component;
   }
