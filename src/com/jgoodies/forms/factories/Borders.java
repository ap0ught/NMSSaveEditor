...
public final class Borders {
   ...
   public static final Border DIALOG_BORDER = createEmptyBorder(
   ...
   public static final class EmptyBorder extends AbstractBorder {
      // $VF: renamed from: top com.jgoodies.forms.layout.ConstantSize
      private final ConstantSize field_53;
      ...
      public Insets getBorderInsets(Component c, Insets insets) {
         insets.top = this.field_53.getPixelSize(c);
