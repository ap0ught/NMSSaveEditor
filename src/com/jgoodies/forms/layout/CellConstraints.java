...
public final class CellConstraints implements Cloneable, Serializable {
   ...
   public static final CellConstraints.Alignment field_44 = new CellConstraints.Alignment("top", 1);
   public static final CellConstraints.Alignment BOTTOM = new CellConstraints.Alignment("bottom", 1);
   private static final CellConstraints.Alignment[] VALUES = new CellConstraints.Alignment[]{DEFAULT, FILL, LEFT, RIGHT, CENTER, field_44, BOTTOM};
   ...
   public CellConstraints(
      int gridX, int gridY, int gridWidth, int gridHeight, CellConstraints.Alignment hAlign, CellConstraints.Alignment vAlign, Insets insets
   ) {
      this.gridX = gridX;
      this.gridY = gridY;
   ...
   public CellConstraints method_62(int col, int row) {
      return this.xywh(col, row, 1, 1);
   }

   // $VF: renamed from: xy (int, int, java.lang.String) com.jgoodies.forms.layout.CellConstraints
   public CellConstraints method_63(int col, int row, String encodedAlignments) {
   ...
   public CellConstraints method_64(int col, int row, CellConstraints.Alignment colAlign, CellConstraints.Alignment rowAlign) {
      return this.xywh(col, row, 1, 1, colAlign, rowAlign);
   }

   // $VF: renamed from: xyw (int, int, int) com.jgoodies.forms.layout.CellConstraints
   public CellConstraints method_65(int col, int row, int colSpan) {
   ...
   public CellConstraints method_66(int col, int row, int colSpan, String encodedAlignments) {
   ...
   public CellConstraints method_67(int col, int row, int colSpan, CellConstraints.Alignment colAlign, CellConstraints.Alignment rowAlign) {
   ...
   public CellConstraints method_68(int row, int col) {
      return this.rchw(row, col, 1, 1);
   }

   // $VF: renamed from: rc (int, int, java.lang.String) com.jgoodies.forms.layout.CellConstraints
   public CellConstraints method_69(int row, int col, String encodedAlignments) {
   ...
   public CellConstraints method_70(int row, int col, CellConstraints.Alignment rowAlign, CellConstraints.Alignment colAlign) {
      return this.rchw(row, col, 1, 1, rowAlign, colAlign);
   }

   // $VF: renamed from: rcw (int, int, int) com.jgoodies.forms.layout.CellConstraints
   public CellConstraints method_71(int row, int col, int colSpan) {
   ...
   public CellConstraints method_72(int row, int col, int colSpan, String encodedAlignments) {
   ...
   public CellConstraints method_73(int row, int col, int colSpan, CellConstraints.Alignment rowAlign, CellConstraints.Alignment colAlign) {
   ...
   private CellConstraints.Alignment usedAlignment(CellConstraints.Alignment cellAlignment, FormSpec formSpec) {
      if (cellAlignment != DEFAULT) {
         ...
         if (defaultAlignment == FormSpec.FILL_ALIGN) {
            ...
            return defaultAlignment == RowSpec.field_43 ? field_44 : BOTTOM;
         }
      }
   }
   ...
   public static final class Alignment implements Serializable {
      ...
      static CellConstraints.Alignment valueOf(String nameOrAbbreviation) {
         ...
         if (str.equals("d") || str.equals("default")) {
            ...
            return CellConstraints.field_44;
         } else if (!str.equals("b") && !str.equals("bottom")) {
            throw new IllegalArgumentException(
               "Invalid alignment " + nameOrAbbreviation + ". Must be one of: left, center, right, top, bottom, " + "fill, default, l, c, r, t, b, f, d."
            );
         } else {
