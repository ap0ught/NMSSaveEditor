...
public final class DefaultUnitConverter extends AbstractUnitConverter {
   ...
   protected double getDialogBaseUnitsX(Component component) {
      return this.getDialogBaseUnits(component).field_36;
   }

   protected double getDialogBaseUnitsY(Component component) {
      return this.getDialogBaseUnits(component).field_37;
   }
   ...
   private static final class DialogBaseUnits {
      // $VF: renamed from: x double
      final double field_36;
      // $VF: renamed from: y double
      final double field_37;

      DialogBaseUnits(double dialogBaseUnitsX, double dialogBaseUnitsY) {
         this.field_36 = dialogBaseUnitsX;
         this.field_37 = dialogBaseUnitsY;
      }

      public String toString() {
         return "DBU(x=" + this.field_36 + "; y=" + this.field_37 + ")";
      }
   }
}
