...
public class LZ4BlockInputStream extends FilterInputStream {
   ...
   public LZ4BlockInputStream(InputStream in, LZ4FastDecompressor decompressor, Checksum checksum, boolean stopOnEmptyBlock) {
      ...
      this.field_158 = this.originalLen = 0;
      this.finished = false;
   }
   ...
   public int available() throws IOException {
      return this.originalLen - this.field_158;
   }
   ...
   public int read() throws IOException {
      if (this.finished) {
         ...
         if (this.field_158 == this.originalLen) {
            this.refill();
         }

         return this.finished ? -1 : this.buffer[this.field_158++] & 0xFF;
      }
   }
   ...
   public int read(byte[] b, int off, int len) throws IOException {
      ...
      if (this.finished) {
         ...
         if (this.finished) {
            ...
            len = Math.min(len, this.originalLen - this.field_158);
            System.arraycopy(this.buffer, this.field_158, b, off, len);
            this.field_158 += len;
            return len;
         }
      }
   ...
   public long skip(long n) throws IOException {
      if (n > 0L && !this.finished) {
         ...
         if (this.finished) {
            ...
            int skipped = (int)Math.min(n, (long)(this.originalLen - this.field_158));
            this.field_158 += skipped;
            return (long)skipped;
         }
      } else {
         return 0L;
