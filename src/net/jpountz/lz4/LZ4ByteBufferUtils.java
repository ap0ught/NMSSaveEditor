...
enum LZ4ByteBufferUtils {
   ...
   static void copyTo(LZ4ByteBufferUtils.Match m1, LZ4ByteBufferUtils.Match m2) {
      m2.field_35 = m1.field_35;
      m2.start = m1.start;
      m2.field_34 = m1.field_34;
   }
   ...
   static class Match {
      ...
      void method_59(int correction) {
         this.start += correction;
         this.field_34 += correction;
         this.field_35 -= correction;
      }

      // $VF: renamed from: end () int
      int method_60() {
         return this.start + this.field_35;
      }
   }
}
