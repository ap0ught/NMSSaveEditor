...
enum LZ4SafeUtils {
   ...
   static void copyTo(LZ4SafeUtils.Match m1, LZ4SafeUtils.Match m2) {
      m2.field_31 = m1.field_31;
      m2.start = m1.start;
      m2.field_30 = m1.field_30;
   }
   ...
   static class Match {
      ...
      void method_57(int correction) {
         this.start += correction;
         this.field_30 += correction;
         this.field_31 -= correction;
      }

      // $VF: renamed from: end () int
      int method_58() {
         return this.start + this.field_31;
      }
   }
}
