...
public class aH {
   ...
   public static void b(String var0, int var1) {
      cK.c(var0, Integer.valueOf(var1));
      cL = true;
   }
                  ...
                  try {
                     ...
                     if (!var7.equals("InventoryFontScale")) {
                        if (var7.equals("InventoryScaling")) {
                           cK.b("InventoryScaling", Double.parseDouble(var9));
                        } else if (var7.equals("FontScaling")) {
                           cK.b("FontScaling", Double.parseDouble(var9));
                           ...
                           if ((var5 = var9.indexOf(44)) > 0) {
                              ...
                              cK.c(var7 + ".X", Integer.valueOf(var10));
                              cK.c(var7 + ".Y", Integer.valueOf(var11));
                           }
                           ...
                           if ((var24 = var9.indexOf(44)) > 0) {
                              ...
                              cK.c(var7 + ".Width", Integer.valueOf(var28));
                              cK.c(var7 + ".Height", Integer.valueOf(var30));
                           }
                        } else if (var7.equals("JSONEditor.Divider")) {
                           int var29 = Integer.parseInt(var9);
                           cK.c(var7, Integer.valueOf(var29));
   ...
   public static void V() {
      ...
      aI var1 = Stream.of(aI.values()).filter(var1x -> var1x.name().equalsIgnoreCase(var0)).findFirst().orElse(aI.cN);
...
// Stub class for missing aH static references
public class aH {
    public static File cD = new File(".");
    public static File cE = new File(".");
    public static File cF = new File(".");
    public static int cH = 100;
    public static int cI = 100;

    public static void init(boolean var1) {
        // Stub implementation
    }
    ...
    public static int a(String key, int defaultValue) {
        return defaultValue;
    }
