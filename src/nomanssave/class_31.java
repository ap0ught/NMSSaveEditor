...
// $VF: renamed from: nomanssave.hk
public class class_31 {
   // $VF: renamed from: sM java.lang.String
   private static final String field_84 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";

   // $VF: renamed from: k (byte[]) java.lang.String
   public static String method_116(byte[] var0) {
   ...
   // $VF: renamed from: aD (java.lang.String) byte[]
   public static byte[] method_117(String var0) {
   ...
   // $VF: renamed from: a (java.io.OutputStream, int) void
   public static void method_118(OutputStream var0, int var1) {
   ...
   // $VF: renamed from: f (java.io.InputStream) long
   public static long method_119(InputStream var0) {
   ...
   // $VF: renamed from: b (java.io.OutputStream, long) void
   public static void method_120(OutputStream var0, long var1) {
   ...
   // $VF: renamed from: l (java.io.File) byte[]
   public static byte[] method_121(File var0) {
      FileInputStream var1 = new FileInputStream(var0);

      byte[] var3;
      try {
         var3 = method_122(var1);
      } finally {
         var1.close();
      }
   ...
   // $VF: renamed from: g (java.io.InputStream) byte[]
   public static byte[] method_122(InputStream var0) {
      ByteArrayOutputStream var1 = new ByteArrayOutputStream();
