...
// $VF: renamed from: nomanssave.hh
public class class_33 {
   // $VF: renamed from: sx long
   private static final long field_87 = 255L;
   // $VF: renamed from: sy int
   private static final int field_88 = 12;
   // $VF: renamed from: sz int
   private static final int field_89 = 96;
   // $VF: renamed from: sA int
   private static final int field_90 = 48;
   // $VF: renamed from: sB int
   private static final int field_91 = 12;
   // $VF: renamed from: sC int
   private static final int field_92 = 192;
   // $VF: renamed from: sD int
   private static final int field_93 = 96;
   // $VF: renamed from: sE int
   private static final int field_94 = 24;
   // $VF: renamed from: sF long
   private static final long field_95 = -2401053088876216593L;
   // $VF: renamed from: sG long
   private final long field_96;
   // $VF: renamed from: sH long
   private final long field_97;

   // $VF: renamed from: a (byte[], int) long
   private static long method_128(byte[] var0, int var1) {
   ...
   // $VF: renamed from: b (byte[], int, int) long
   private static long method_129(byte[] var0, int var1, int var2) {
      long var3 = 0L;
      switch (var2) {
         case 7:
   ...
   // $VF: renamed from: a (byte[], int, int, long[]) void
   private static void method_130(byte[] var0, int var1, int var2, long[] var3) {
      long var4 = var3[0];
      long var6 = var3[1];
      ...
      for (var13 = var1; var12 >= 32; var12 -= 32) {
         long var65 = var8 + method_128(var0, var13);
         var10 += method_128(var0, var13 + 8);
         ...
         var6 += var8;
         var10 ^= var6;
         var4 += method_128(var0, var13 + 16);
         var6 += method_128(var0, var13 + 24);
         var13 += 32;
      }

      if (var12 >= 16) {
         long var74 = var8 + method_128(var0, var13);
         var10 += method_128(var0, var13 + 8);
         var13 += 16;
         var12 -= 16;
      ...
      var10 += (long)var2 << 56;
      if (var12 >= 8) {
         var8 += method_128(var0, var13);
         var13 += 8;
         var12 -= 8;
         if (var12 > 0) {
            var10 += method_129(var0, var13, var12);
         }
      } else if (var12 > 0) {
         var8 += method_129(var0, var13, var12);
      } else {
   ...
   // $VF: renamed from: b (byte[], int, int, long[]) long
   public static long method_131(byte[] var0, int var1, int var2, long[] var3) {
      if (var2 < 192) {
         method_130(var0, var1, var2, var3);
         return var3[0];
      } else {
         long var10;
         long var16;
         ...
         int var31 = var28 >>> 3;
         if (var30 > 0) {
            long var32 = method_129(var0, var29 + (var31 << 3), var30);
            switch (var31) {
               case 0:
                  var4 += var32;
                  break;
         ...
         switch (var31) {
            case 11:
               var24 += method_128(var0, var29 + 80);
            case 10:
               var22 += method_128(var0, var29 + 72);
            case 9:
               var20 += method_128(var0, var29 + 64);
            case 8:
               var18 += method_128(var0, var29 + 56);
            case 7:
               var16 += method_128(var0, var29 + 48);
            case 6:
               var14 += method_128(var0, var29 + 40);
            case 5:
               var12 += method_128(var0, var29 + 32);
            case 4:
               var10 += method_128(var0, var29 + 24);
            case 3:
               var8 += method_128(var0, var29 + 16);
            case 2:
               var6 += method_128(var0, var29 + 8);
            case 1:
               var4 += method_128(var0, var29);
            default:
               var26 += (long)var28 << 56;
   ...
   // $VF: renamed from: a (java.lang.CharSequence, int) long
   private static long method_132(CharSequence var0, int var1) {
      return (long)var0.charAt(var1 + 3) << 48 | (long)var0.charAt(var1 + 2) << 32 | (long)var0.charAt(var1 + 1) << 16 | (long)var0.charAt(var1);
   }

   // $VF: renamed from: a (java.lang.CharSequence, int, int) long
   private static long method_133(CharSequence var0, int var1, int var2) {
      long var3 = 0L;
      switch (var2) {
         case 3:
   ...
   // $VF: renamed from: a (java.lang.CharSequence, int, int, long[]) void
   private static void method_134(CharSequence var0, int var1, int var2, long[] var3) {
      long var4 = var3[0];
      long var6 = var3[1];
      long var8 = -2401053088876216593L;
      long var10 = -2401053088876216593L;
      ...
      for (var13 = var1; var12 >= 16; var12 -= 16) {
         long var65 = var8 + method_132(var0, var13);
         var10 += method_132(var0, var13 + 4);
         long var66 = var65 << 50 | var65 >>> 14;
         long var67 = var66 + var10;
         var4 ^= var67;
         var10 = var10 << 52 | var10 >>> 12;
         ...
         var6 += var8;
         var10 ^= var6;
         var4 += method_132(var0, var13 + 8);
         var6 += method_132(var0, var13 + 12);
         var13 += 16;
      }

      if (var12 >= 8) {
         long var74 = var8 + method_132(var0, var13);
         var10 += method_132(var0, var13 + 4);
         var13 += 8;
         var12 -= 8;
         long var75 = var74 << 50 | var74 >>> 14;
      ...
      if (var12 >= 4) {
         var8 += method_132(var0, var13);
         var13 += 4;
         var12 -= 4;
         if (var12 > 0) {
            var10 += method_133(var0, var13, var12);
         }
      } else if (var12 > 0) {
         var8 += method_133(var0, var13, var12);
      } else {
         var8 += -2401053088876216593L;
         var10 += -2401053088876216593L;
      }
   ...
   // $VF: renamed from: b (java.lang.CharSequence, int, int, long[]) long
   public static long method_135(CharSequence var0, int var1, int var2, long[] var3) {
      if (var2 < 96) {
         method_134(var0, var1, var2, var3);
         return var3[0];
      } else {
         long var10;
         long var16;
         ...
         for (var29 = var1; var28 >= 48; var29 += 48) {
            long var34 = var4 + method_132(var0, var29);
            long var46 = var8 ^ var24;
            var26 ^= var34;
            long var35 = var34 << 11 | var34 >>> 53;
            var26 += var6;
            var6 += method_132(var0, var29 + 4);
            long var52 = var10 ^ var26;
            long var36 = var35 ^ var6;
            var6 = var6 << 32 | var6 >>> 32;
            long var37 = var36 + var46;
            long var47 = var46 + method_132(var0, var29 + 8);
            long var58 = var12 ^ var37;
            var6 ^= var47;
            long var48 = var47 << 43 | var47 >>> 21;
            var6 += var52;
            long var53 = var52 + method_132(var0, var29 + 12);
            long var64 = var14 ^ var6;
            long var49 = var48 ^ var53;
            long var54 = var53 << 31 | var53 >>> 33;
            var8 = var49 + var58;
            long var59 = var58 + method_132(var0, var29 + 16);
            long var70 = var16 ^ var8;
            long var55 = var54 ^ var59;
            long var60 = var59 << 17 | var59 >>> 47;
            var10 = var55 + var64;
            long var65 = var64 + method_132(var0, var29 + 20);
            long var76 = var18 ^ var10;
            long var61 = var60 ^ var65;
            long var66 = var65 << 28 | var65 >>> 36;
            var12 = var61 + var70;
            long var71 = var70 + method_132(var0, var29 + 24);
            long var82 = var20 ^ var12;
            long var67 = var66 ^ var71;
            long var72 = var71 << 39 | var71 >>> 25;
            var14 = var67 + var76;
            long var77 = var76 + method_132(var0, var29 + 28);
            long var88 = var22 ^ var14;
            long var73 = var72 ^ var77;
            long var78 = var77 << 57 | var77 >>> 7;
            var16 = var73 + var82;
            long var83 = var82 + method_132(var0, var29 + 32);
            var24 ^= var16;
            long var79 = var78 ^ var83;
            long var84 = var83 << 55 | var83 >>> 9;
            var18 = var79 + var88;
            long var89 = var88 + method_132(var0, var29 + 36);
            var26 ^= var18;
            long var85 = var84 ^ var89;
            long var90 = var89 << 54 | var89 >>> 10;
            var20 = var85 + var24;
            var24 += method_132(var0, var29 + 40);
            var4 = var37 ^ var20;
            long var91 = var90 ^ var24;
            var24 = var24 << 22 | var24 >>> 42;
            var22 = var91 + var26;
            var26 += method_132(var0, var29 + 44);
            var6 ^= var22;
            var24 ^= var26;
            var26 = var26 << 46 | var26 >>> 18;
            var24 += var4;
         ...
         int var31 = var28 >> 2;
         if (var30 > 0) {
            long var32 = method_133(var0, var29 + (var31 << 2), var30);
            switch (var31) {
               case 0:
                  var4 += var32;
                  break;
         ...
         switch (var31) {
            case 11:
               var24 += method_132(var0, var29 + 40);
            case 10:
               var22 += method_132(var0, var29 + 36);
            case 9:
               var20 += method_132(var0, var29 + 32);
            case 8:
               var18 += method_132(var0, var29 + 28);
            case 7:
               var16 += method_132(var0, var29 + 24);
            case 6:
               var14 += method_132(var0, var29 + 20);
            case 5:
               var12 += method_132(var0, var29 + 16);
            case 4:
               var10 += method_132(var0, var29 + 12);
            case 3:
               var8 += method_132(var0, var29 + 8);
            case 2:
               var6 += method_132(var0, var29 + 4);
            case 1:
               var4 += method_132(var0, var29);
            default:
   ...
   // $VF: renamed from: a (long[], int, int, long[]) void
   private static void method_136(long[] var0, int var1, int var2, long[] var3) {
      long var4 = var3[0];
      long var6 = var3[1];
      long var8 = -2401053088876216593L;
      long var10 = -2401053088876216593L;
   ...
   // $VF: renamed from: b (long[], int, int, long[]) long
   public static long method_137(long[] var0, int var1, int var2, long[] var3) {
      if (var2 < 24) {
         method_136(var0, var1, var2, var3);
         return var3[0];
      } else {
         long var10;
         long var16;
   ...
   public class_33(long var1, long var3) {
      this.field_96 = var1;
      this.field_97 = var3;
   }

   // $VF: renamed from: a (byte[], long[]) long
   public static long method_138(byte[] var0, long[] var1) {
      return method_131(var0, 0, var0.length, var1);
   }

   // $VF: renamed from: c (byte[], int, int) long[]
   public long[] method_139(byte[] var1, int var2, int var3) {
      long[] var4 = new long[]{this.field_96, this.field_97};
      method_131(var1, var2, var3, var4);
      return var4;
   }

   // $VF: renamed from: j (byte[]) long[]
   public long[] method_140(byte[] var1) {
      return this.method_139(var1, 0, var1.length);
   }

   // $VF: renamed from: a (java.lang.CharSequence, long[]) long
   public static long method_141(CharSequence var0, long[] var1) {
      return method_135(var0, 0, var0.length(), var1);
   }

   // $VF: renamed from: b (java.lang.CharSequence, int, int) long[]
   public long[] method_142(CharSequence var1, int var2, int var3) {
      long[] var4 = new long[]{this.field_96, this.field_97};
      method_135(var1, var2, var3, var4);
      return var4;
   }

   // $VF: renamed from: a (java.lang.CharSequence) long[]
   public long[] method_143(CharSequence var1) {
      return this.method_142(var1, 0, var1.length());
   }

   // $VF: renamed from: a (long[], long[]) long
   public static long method_144(long[] var0, long[] var1) {
      return method_137(var0, 0, var0.length, var1);
   }

   // $VF: renamed from: b (long[], int, int) long[]
   public long[] method_145(long[] var1, int var2, int var3) {
      long[] var4 = new long[]{this.field_96, this.field_97};
      method_137(var1, var2, var3, var4);
      return var4;
   }

   // $VF: renamed from: b (long[]) long[]
   public long[] method_146(long[] var1) {
      return this.method_145(var1, 0, var1.length);
   }
}
