...
class class_379 extends class_374 {
   class_379(class_368 var1) {
   ...
   protected String method_1315(String var1) {
      class_39 var2 = (class_39)class_368.method_1238(this.field_1366).getSelectedItem();
      if (var2 == null) {
         return "";
      } else {
         double var3 = var2.method_212();

         try {
            double var5 = class_35.method_151(var1, 0.0, 1000.0);
            if (var5 != var3) {
               var2.method_213(var5);
            }
