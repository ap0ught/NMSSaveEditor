...
class class_385 extends class_374 {
   class_385(class_369 var1) {
   ...
   protected String method_1315(String var1) {
      class_75 var2 = (class_75)class_369.method_1265(this.field_1372).getSelectedItem();
      if (var2 == null) {
         return "";
      } else {
         double var3 = var2.method_448();

         try {
            double var5 = class_35.method_151(var1, 0.0, 1000.0);
            if (var5 != var3) {
               var2.method_449(var5);
            }
