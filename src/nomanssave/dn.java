...
public class dN extends em {
   ...
   dN(Application var1) {
            ...
            var2x -> {
               ...
               if (var3 != null) {
                  ...
                  int var5 = JOptionPane.showConfirmDialog(
                     var1.g(),
                     "You are about to change a ship type to "
                        + (var4 == null ? "Unknown" : var4.toString())
                        + ". Are you sure?\nNOTE: Any incompatible technology installed on the ship will be deleted.",
                     "Change Ship Type",
                     0
                  );
                  if (var5 != 0) {
      ...
      this.hN.a(var1x -> {
         gH var2x = (gH)this.hK.getModel().getSelectedItem();
         if (var2x != null) {
            var2x.aj(var1x);
         }
      });
      ...
      this.k("Base Stats");
      this.hQ = new dW(this);
      this.a("Health", this.hQ);
      this.hR = new dX(this);
      this.a("Shield", this.hR);
      this.hS = new dY(this);
      this.a("Damage", this.hS);
      this.hT = new dZ(this);
      this.a("Shields", this.hT);
      this.hU = new ea(this);
      this.a("Hyperdrive", this.hU);
      this.hV = new dP(this);
      this.a("Maneuverability", this.hV);
      this.Y();
