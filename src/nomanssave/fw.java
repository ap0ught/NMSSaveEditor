         ...
         System.out
            .println(
               "  unknown3 = "
                  + this.lR
                  + " 0x"
                  + Integer.toHexString(this.lR)
                  + " "
                  + Integer.toBinaryString(this.lR)
                  + " date:"
                  + new Date(1000L * (long)this.lR)
            );
      }
         ...
         System.out
            .println(
               "  unknown4 = "
                  + this.lS
                  + " 0x"
                  + Integer.toHexString(this.lS)
                  + " "
                  + Integer.toBinaryString(this.lS)
                  + " len:"
                  + (4294967295L & (long)this.lS)
            );
      }
   }
         ...
         if (var2 < 0) {
            ...
            try {
               ...
               try {
                  ...
                  for (int var28 = var2 + 1; var28 < fu.c(this.lJ).length; var28++) {
                     if (fu.c(this.lJ)[var28].lP < fu.c(this.lJ)[var2].lP) {
                        fu.c(this.lJ)[var28].lP += var9;
                     }

                     var11 += (long)fu.c(this.lJ)[var28].a(var6);
                  }

                  long var29 = fu.c(this.lJ)[var2].lP - var11;
