...
public class gj {
   ...
   public static gj[] o(eY var0) {
      ...
      if (var2 != null) {
         for (int var6 = 0; var6 < var2.size(); var6++) {
            eY var7 = var2.V(var6);
            if (var7.d("CreatureSeed").ab(0)) {
               var1.add(new gj(gl.oG, var6, var7));
            }
         }
      }

      return var1.toArray(new gj[0]);
   }
   ...
   public void af(String var1) {
      this.bf.b("CreatureType.CreatureType", var1);
   }
