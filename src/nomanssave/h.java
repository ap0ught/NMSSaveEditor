...
public class h extends JDialog {
   ...
   private void a() {
      this.t = this.s.stream().map(ey::ba).distinct().sorted((var0, var1) -> var0.name().compareTo(var1.name())).collect(Collectors.toList());
   ...
   private void b() {
      ...
      this.u = this.s
         .stream()
         .filter(var1x -> var1x.ba() == var1)
         .map(ey::bc)
         .distinct()
         .sorted((var0, var1x) -> var0.name().compareTo(var1x.name()))
   ...
   private void c() {
      ...
      this.v = this.s
         .stream()
         .filter(var2x -> var2x.ba() == var1 && var2x.bc() == var2 && (var2 != ex.iZ || !var2x.be()))
         .sorted((var0, var1x) -> var0.getName().compareTo(var1x.getName()))
         .collect(Collectors.toList());
