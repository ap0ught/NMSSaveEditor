...
public class ho extends FilterOutputStream
{
    ...
    public ho(final OutputStream out) {
        super(out);
        this.sf = ho.se.fastCompressor();
    ...
    private void ek() {
        ...
        this.out.write(new byte[] { (byte)(0xFF & this.sg), (byte)(0xFF & this.sg >> 8), (byte)(0xFF & this.sg >> 16), (byte)(0xFF & this.sg >> 24), (byte)(0xFF & compress), (byte)(0xFF & compress >> 8), (byte)(0xFF & compress >> 16), (byte)(0xFF & compress >> 24) });
